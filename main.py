...
def main(config):
    ...
    if config.mode == 'train':
        ...
        # elif config.dataset in ['Both']:
        #     solver.test_multi()
    elif config.mode == 'test_single_image':
        if config.dataset in ['CelebA', 'RaFD']:
            solver.test_single_image()
        # elif config.dataset in ['Both']:
        #     solver.test_single_image()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_iters', type=int, default=180000, help='test model from this step')
    ...
    # Directories.
    parser.add_argument('--celeba_image_dir', type=str, default='/public/huangqidong/stargan/img_align_celeba')
    parser.add_argument('--attr_path', type=str, default='Anno/list_attr_celeba.txt')
